...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code recursion.StdDraw.BLACK}, {@code recursion.StdDraw.BLUE}, {@code recursion.StdDraw.CYAN},
     * {@code recursion.StdDraw.DARK_GRAY}, {@code recursion.StdDraw.GRAY}, {@code recursion.StdDraw.GREEN},
     * {@code recursion.StdDraw.LIGHT_GRAY}, {@code recursion.StdDraw.MAGENTA}, {@code recursion.StdDraw.ORANGE},
     * {@code recursion.StdDraw.PINK}, {@code recursion.StdDraw.RED}, {@code recursion.StdDraw.WHITE}, and
     * {@code recursion.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to recursion.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to recursion.StdDraw)
        try {
            URL url = recursion.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {

...
public class AbonnementenDAO implements ISubscriptionDAO {
    ...
    public boolean addAbonnement(Abonnement abonnement, String token) {
        ...
        Abonnement searchAbonnement = getAbonnement(abonnement.getId());
        ...
        try (
            ...
            preparedStatementAddSubscription.setInt(2, abonnement.getId());
            preparedStatementAddSubscription.setString(3, abonnement.getAanbieder());
            preparedStatementAddSubscription.setString(4, abonnement.getDienst());
            preparedStatementAddSubscription.setFloat(5, searchAbonnement.getPrijs());
            preparedStatementAddSubscription.setString(6, searchAbonnement.getVerdubbeling());
            preparedStatementAddSubscription.setBoolean(7, searchAbonnement.isDeelbaar());
            preparedStatementAddSubscription.setString(8,"actief");
    ...
    public Abonnement getAbonnement(int id) {
        ...
        Abonnement abonnement = new Abonnement();
        String selectSubsubscriptionSQL = "SELECT prijs,verdubbeling,deelbaar FROM Subscription WHERE  id=?";
    ...
    public boolean shareAbonnement(String token, int id, Abonnement abonnement) {
        Abonnement abonnement2 = getUserAbonnement(token, abonnement.getId());
        String token1 = getToken(id);
        return addAbonnement(abonnement2, getToken(id));
    }
}